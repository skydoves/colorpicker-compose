...
object Versions {
    internal const val ANDROID_GRADLE_PLUGIN = "8.1.1"
    internal const val ANDROID_GRADLE_SPOTLESS = "6.21.0"
    internal const val GRADLE_NEXUS_PUBLISH_PLUGIN = "1.3.0"
    internal const val KOTLIN = "1.9.10"
    internal const val KOTLIN_GRADLE_DOKKA = "1.9.0"
    ...
    internal const val COMPOSE_BOM = "2023.09.01"
    internal const val COMPOSE_COMPILER = "1.5.3"
